...
import com.earncash.rewardsapp.csm.DialogFrag.Dialog_Reward;
...
public class Redeem_adapter extends RecyclerView.Adapter<Redeem_adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_csm_redeem_amount, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.coins.setText(model.getCoins()+" COINS");
