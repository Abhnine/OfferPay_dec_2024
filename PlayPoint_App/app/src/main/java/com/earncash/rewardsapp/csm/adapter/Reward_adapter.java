...
import com.earncash.rewardsapp.csm.activity.RewardActivity;
...
public class Reward_adapter extends RecyclerView.Adapter<Reward_adapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_csm_reward_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Glide.with(context).load(Main_Url+model.getImage())
        ...
        holder.cv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(context, RewardActivity.class);
                ...
                i.putExtra("min", model.getMinimum());
        ...
        holder.progressBar.setMax(coi);
        if (coi >= model.getMinimum()) {
            holder.points.setText("Completed!");
            holder.progressBar.setProgress(coi);
            //holder.progressBar.setProgressDrawable(ContextCompat.getDrawable(context, R.drawable.progress_csm));
        } else {
            int a = model.getMinimum() - coi;
            holder.points.setText(a + " coins needed!");
